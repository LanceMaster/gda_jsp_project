  ...
  <div class="login-modal-custom position-relative">
    ...
    <form id="loginForm" action="${pageContext.request.contextPath}/user/login" method="post" autocomplete="off">
      <div class="form-group">
        ...
        <input type="text" name="id" id="loginId" class="form-control" placeholder="아이디를 입력하세요" required />
      </div>

      <div class="form-group">
        <label for="loginPassword" class="sr-only">비밀번호</label>
        <span class="input-icon"><i class="fas fa-lock"></i></span>
        <input type="password" name="password" id="loginPassword" class="form-control" placeholder="비밀번호를 입력하세요" required />
      </div>

      <div class="login-links d-flex justify-content-between">
      <a href="#" class="find-id-btn">아이디 찾기</a>
      
        <a href="#" class="find-pw-btn">비밀번호 찾기</a>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <form id="findIdForm" class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          <label for="nameForFindId">이름</label>
          <input type="text" class="form-control" id="nameForFindId" name="name" placeholder="이름을 입력하세요" required />
        </div>
        <div class="form-group">
          <label for="birthForFindId">생년월일</label>
          <input type="date" class="form-control" id="birthForFindId" name="birth" required />
        </div>
        <div id="findIdResult" class="text-info mt-2" style="display: none;"></div>
      </div>
        ...
        <form id="findPwForm" class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nameForId" name="name" placeholder="이름을 입력하세요" required />
            </div>
            <div class="form-group">
              <label for="emailForPw">가입한 이메일</label>
              <input type="email" class="form-control" id="emailForPw" name="email" placeholder="이메일을 입력하세요" required />
            </div>
            <div id="findPwResult" class="text-info mt-2" style="display: none;"></div>
          </div>
          <div class="modal-footer">
