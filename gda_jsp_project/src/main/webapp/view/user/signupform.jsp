...
<html>
  ...
  <body>
      ...
      >
        ...
        <div class="form-group email-group">
          ...
          <button
            ...
            class="btn login-btn-main"
            id="emailVerifyBtn"
            style="flex: 1; min-width: 120px; margin-left: 8px"
            disabled
          >
            이메일 인증하기
          </button>
        ...
        <div class="form-group" id="resumeGroup" style="display: none">
          ...
          />
          <span style="font-size: 0.98rem; color: #888; margin-left: 8px"
            >이력서 파일 (PDF, HWP, DOC, DOCX)</span
          >
        </div>

        <div class="agree-group">
          <label style="font-size: 0.98rem">
            <input type="checkbox" name="agree" required /> 이용 약관에
            동의합니다.
          </label>
        </div>
        <button
    ...
    <script>
      // 중복확인 버튼 클릭 시
      $(document)
        .off("click", "#emailDupCheckBtn")
        .on("click", "#emailDupCheckBtn", function () {
          ...
          $.ajax({
            url: "${pageContext.request.contextPath}/user/emailDupCheck",
            method: "POST",
            data: { email: email },
