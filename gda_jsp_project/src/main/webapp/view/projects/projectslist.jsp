...
<head>
  <title>프로젝트 목록</title>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/projectslist.css" />
</head>
    ...
    <c:choose>
      <c:when test="${pageInfo.pages > 0}">
        <c:forEach begin="1" end="${pageInfo.pages}" var="i">
          <a href="?pageNum=${i}&keyword=${param.keyword}&sort=${param.sort}&status=${param.status}"
